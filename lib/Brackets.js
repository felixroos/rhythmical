...
class Brackets {
    ...
    static split(string, modify = s => [s]) {
    ...
    static resolve(string, modify = s => [s]) {
    ...
    static divide(string, symbol) {
        const divided = string.split(symbol);
        return Brackets.simplify(divided);
    }
    static divideHierarchy(string, symbolHierarchy) {
    ...
    static divideDeep(tree, divideHierarchy = [' | ', ' . ', ' ']) {
