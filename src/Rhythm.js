...
var Rhythm = /** @class */ (function () {
    ...
    Rhythm.duration = function (path, whole) {
        ...
        return path.reduce(function (f, p) { return (f / p[1]) * (p[2] || 1); }, whole);
    };
    ...
    Rhythm.calculate = function (totalLength) {
        ...
        return function (_a) {
            var time = _a.time, duration = _a.duration, path = _a.path, value = _a.value, length = _a.length;
    ...
    Rhythm.useValueAsDuration = function (event) {
        return __assign(__assign({}, event), { duration: event.duration * event.value });
    };
    Rhythm.useValueAsLength = function (event) {
        return __assign(__assign({}, event), { length: event.value });
    };
    Rhythm.poly = function (rhythms, length) {
        if (length === void 0) { length = 1; }
        var toArray = function (r) { return (!Array.isArray(r) ? [r] : r); };
        ...
        return items.reduce(function (nested, item) {
            ...
            if (item.path.length === 1) {
                ...
                nested[item.path[0]] = Rhythm.nest(items
                    ...
                    .map(function (i) { return (__assign(__assign({}, i), { path: i.path.slice(1), divisions: i.divisions.slice(1) })); }), fill);
            }
            return nested;
        }, []);
    };
        ...
        return items.reduce(function (expanded, item, index) {
            if (item.path.length === 1) {
                ...
                var siblings = items
                    ...
                    .map(function (i) { return (__assign(__assign({}, i), { path: i.path.slice(1) })); });
    ...
    Rhythm.prototype.addGroove = function (items, pulse) {
        ...
        return rendered.reduce(function (combined, chordEvent, index) {
            ...
            combined = __assign(__assign({}, combined), (_a = {}, _a[chordEvent.value] = Rhythm.getBlock(chordEvent.duration, time), _a));
    ...
    Rhythm.flat = function (rhythm, path, poly, props) {
            ...
            duration = rhythm.reduce(function (sum, item) {
                ...
                if (Array.isArray(item['duration'])) {
                    if (item[Music_1.params.monophony]) {
                        item['duration'] =
                            item[Music_1.params.monophony].length * item['duration'][0];
        ...
        return rhythm.reduce(function (flat, item, index) {
            ...
            if (typeof item === 'object') {
                ...
                Object.keys(item)
                    .filter(function (key) { return collectedKeys_1.includes(key); })
                ...
                props = Object.keys(props).reduce(function (p, key) {
                    var _a;
                    return (__assign(__assign({}, p), (_a = {}, _a[key] = [null].concat(props[key]), _a)));
                }, props);
            }
        ...
        return items.reduce(function (nested, item) {
            ...
            if (item.path.length === 1) {
                ...
                nested[item.path[0][0]] = Rhythm.nested(items
                    ...
                    .map(function (i) { return (__assign(__assign({}, i), { path: i.path.slice(1) })); }), fill);
            }
            return nested;
        }, []);
    };
    ...
    Rhythm.align = function () {
        ...
        return paths.map(function (p) {
            return p.concat(Array(Rhythm.maxArray(paths.map(function (p) { return p.length; })) - p.length).fill([0, 1]));
        });
    };
    ...
    Rhythm.fixTopLevel = function (events) {
        ...
        return events.map(function (e) { return (__assign(__assign({}, e), { path: e.path.map(function (f, i) { return (!i ? [f[0], max] : f); }) })); });
    };
    ...
    Rhythm.shiftEvents = function (events, path) {
        if (path) {
            events = events.map(function (e) { return (__assign(__assign({}, e), { path: Rhythm.add(e.path, path) })); });
        }
